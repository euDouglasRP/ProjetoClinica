...
public class ProntuarioDeSaidaCadastro extends javax.swing.JFrame {

  
    public ProntuarioDeSaidaCadastro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro Prontario de Saida");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProntuarioDeSaidaCadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProntuarioDeSaidaCadastro().setVisible(true);
            }
        });
    }
